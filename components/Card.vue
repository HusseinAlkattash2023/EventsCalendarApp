<template>
    <div class="relative lg:my-0 my-3 cursor-pointer flex flex-col items-center justify-center w-80 md:w-96 lg:w-80 xl:w-96 border-2 border-slate-300 rounded shadow-2xl h-44 mx-2">
